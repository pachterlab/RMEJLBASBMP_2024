...
```{r}
# if (seu1_version_control_file_link != "" && (!dir.exists(dirname(seu1_data_path)) || length(list.files(dirname(seu1_data_path))) == 0)) {
#     seu1_data_path_base <- download_box(seu1_version_control_file_link, seu1_data_name_from_download, data_path_root)
#     seu1_data_path <- glue("{seu1_data_path_base}/seu.rds")
#     seu1_markers_data_path <- glue("{seu1_data_path_base}/markers.rds")
# }
# 
# if (seu2_version_control_file_link != "" && (!dir.exists(dirname(seu2_data_path)) || length(list.files(dirname(seu2_data_path))) == 0)) {
#     seu2_data_path_base <- download_box(seu2_version_control_file_link, seu2_data_name_from_download, data_path_root)
