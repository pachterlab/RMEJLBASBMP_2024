...
Select yaml file
```{r}
yaml_file <- "Supp_Fig3"  # Fig1, Supp_Fig2, Supp_Fig3, Supp_Fig4, Supp_Fig5, Supp_Fig19, Supp_Fig19_DE, Supp_Fig20, Supp_Fig20_DE
```
...
if (yaml_file != "Supp_Fig3") {
    sessionInfo()
    stop("Additional biological analysis is only included for the conditions in Supp_Fig3 in the manuscript.")
}
```
