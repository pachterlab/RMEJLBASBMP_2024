...
Select yaml file
```{r}
yaml_file <- "Supp_Fig3"  # Fig1, Supp_Fig2, Supp_Fig3, Supp_Fig4, Supp_Fig5, Supp_Fig18, Supp_Fig18_DE, Supp_Fig19, Supp_Fig19_DE
```
...
if r.scanpy_hvg_flavor != "seurat_v3":
    sc.pp.normalize_total(adata, target_sum=scanpy_normalization_target_sum)
```
