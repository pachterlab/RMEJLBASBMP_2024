...
```{r}
# if (scan1_version_control_file_link != "" && (!dir.exists(dirname(scan1_data_path)) || length(list.files(dirname(scan1_data_path))) == 0)) {
#     scan1_data_path_base <- download_box(scan1_version_control_file_link, scan1_data_name_from_download, data_path_root)
...
# }
# 
# if (scan2_version_control_file_link != "" && (!dir.exists(dirname(scan2_data_path)) || length(list.files(dirname(scan2_data_path))) == 0)) {
#     scan2_data_path_base <- download_box(scan2_version_control_file_link, scan2_data_name_from_download, data_path_root)
...
if not r.doi == "" and not os.path.exists(os.path.dirname(r.scan1_data_path)) or not os.listdir(os.path.dirname(r.scan1_data_path)):  
    r.scan1_data_path_base = download_and_extract(r.doi, r.scan1_data_name_from_download, r.data_path_root)
...
if not r.doi == "" and not os.path.exists(os.path.dirname(r.scan2_data_path)) or not os.listdir(os.path.dirname(r.scan2_data_path)):  
    r.scan2_data_path_base = download_and_extract(r.doi, r.scan2_data_name_from_download, r.data_path_root)
