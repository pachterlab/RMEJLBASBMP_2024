...
Select yaml file
```{r}
yaml_file <- "Fig3_cellranger"  # Fig3_cellranger, Supp_Fig7_Supp_Fig14, Supp_Fig7_DE, Supp_Fig9, Supp_Fig13_Supp_Fig14, Supp_Fig17_seu, Supp_Seurat_version4, Supp_Stats_Bootstrap_Seurat
```
